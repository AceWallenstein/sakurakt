...
class SpProxy private constructor(private val mmkv: MMKV?) : SharedPreferences,
    SharedPreferences.Editor {

    companion object {
        private var instance: SpProxy? = null
        fun getInstance(mmkv: MMKV? = MMKV.defaultMMKV()): SpProxy {
            return instance ?: synchronized(this) {
                return instance ?: SpProxy(mmkv).also { instance = it }
            }
