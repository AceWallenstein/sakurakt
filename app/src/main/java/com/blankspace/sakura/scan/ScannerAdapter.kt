...
import com.blankspace.sakura.databinding.ItemScannerBinding

/**
 * created  by will on 2020/11/22 17:53
 */
class ScannerAdapter(private val callback: (index: Int) -> Unit): ListAdapter<FileItem, ScannerAdapter.ScannerViewHolder>(
    ScannerDifferCallback()
) {
